...
function createPostElement(post) {
    ...
    let displayPost = isRepost ? post.repostOf : post; 
...
function openPostDetail(id) {
    ...
    document.getElementById('post-detail-comments-list').innerHTML = generateCommentsHTML(displayPost.comments, displayPost._id); 
